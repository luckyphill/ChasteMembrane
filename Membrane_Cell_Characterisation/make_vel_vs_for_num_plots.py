...
for i in n_cells:
	y_points = velocities[:,i-1]
	# print y_points
	x_points = forces[y_points> -1]
	# print x_points
	plt.plot(x_points,y_points[y_points> -1])
...
fig_name ="/Users/phillipbrown/Chaste/projects/ChasteMembrane/Membrane_Cell_Characterisation/driving_force_plots/VvsFN/" + file_part + ".png"
