...
CURRENTLY ASSUMES ALL CELLS CAN CONTACT THE MEMRBANE
*/
...
void NormalAdhesionForce<ELEMENT_DIM,SPACE_DIM>::AddForceContribution(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation)
{
    ...
    for (std::list<CellPtr>::iterator cell_iter = cells.begin(); cell_iter != cells.end(); ++cell_iter)
    {
        ...
        double rest_length = mMembranePreferredRadius + mStromalPreferredRadius;
        double spring_constant = mMembraneStromalSpringStiffness;
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
c_vector<double, SPACE_DIM> NormalAdhesionForce<ELEMENT_DIM,SPACE_DIM>::CalculateForceBetweenNodes(unsigned nodeAGlobalIndex,
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void NormalAdhesionForce<ELEMENT_DIM,SPACE_DIM>::SetStromalSpringStiffness(double stromalSpringStiffness)
{
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void NormalAdhesionForce<ELEMENT_DIM,SPACE_DIM>::SetMembraneStromalSpringStiffness(double membraneStromalSpringStiffness)
{
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void NormalAdhesionForce<ELEMENT_DIM,SPACE_DIM>::SetStromalPreferredRadius(double stromalPreferredRadius)
{
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void NormalAdhesionForce<ELEMENT_DIM,SPACE_DIM>::SetMembraneInteractionRadius(double membraneInteractionRadius)
{
    assert(membraneInteractionRadius > 0.0);
    mMembraneInteractionRadius = membraneInteractionRadius;
}
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void NormalAdhesionForce<ELEMENT_DIM,SPACE_DIM>::SetStromalInteractionRadius(double stromalInteractionRadius)
{
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void NormalAdhesionForce<ELEMENT_DIM,SPACE_DIM>::SetDebugMode(bool debugStatus)
{
...
void NormalAdhesionForce<ELEMENT_DIM,SPACE_DIM>::OutputForceParameters(out_stream& rParamsFile)
{
    ...
    *rParamsFile << "\t\t\t<MembraneStromalSpringStiffness>" << mMembraneStromalSpringStiffness << "</MembraneStromalSpringStiffness>\n";
